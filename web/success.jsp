<%@ page import="com.homework5.dao.UserDAO" %>
<%@ page import="java.util.List" %>
<%@ page import="com.homework5.bean.UserEntity" %><%--
...
<body>
<div class="container">
    <jsp:useBean id="f" class="com.homework5.bean.UserEntity" scope="session"/>
            ...
            <tr>
                ...
                <td>
                    <a class="deleteBtn btn btn-danger btn-block btn-lg"
                       href="${pageContext.request.contextPath }/userdelete.action?userid=<%=ue.getUserid()%>">删除
                    </a>
                </td>
            </tr>
        </form>
